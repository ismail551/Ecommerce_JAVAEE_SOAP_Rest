                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
					...
					<tr class="<%=p.getId() %>">      
                      ...
                      <td><%=p.getDate() %></td>
                      <td><%=c.getName() %></td>
                      <td class="tddis" ><a  class="btn btn-danger" id="supprimer" href="actionPhone?d=<%=p.getId() %>" >Delete</a><a  class="btn btn-warning" id="supprimer" href="updatePhone.jsp?p=<%=p.getId() %>" >Update</a></td>               
