                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                   ...
                   <form action="actionCategorie" method="post">
                      ...
                      <td class="tddis" ><i class="fa fa-trash"><input  class="<%=c.getId() %> btn btn-danger" id="supprimer" type="submit" name="action" value="delete"></i><input   class="<%=c.getId() %> btn btn-warning" id="modifier" type="button" name="action" value="update" onclick="update(<%=c.getId() %>)"></td>
                  </form>
